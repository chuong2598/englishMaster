...
public class DifficultWord {
    ...
    public DifficultWord() {
    }

    public DifficultWord(int id, String word, String vietnamese, String similar_word, String ex1, String ex2, int difficulty_level) {
        this.id = id;
        this.word = word;
